...
class CounsellorC extends Controller
{
  public function index($id = null)
  {
    ...
    return view('admin.counsellors')->with($data);
  }
  public function getData(Request $request)
  {
    $rows = Counsellor::paginate(10)->withPath('/admin/testimonials/');
    $i = 1;
  ...
  {
    echo $result = Counsellor::find($id)->delete();
  }
}
