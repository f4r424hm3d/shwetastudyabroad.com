        ...
        <div class="col-lg-12 col-md-12">
          <div class="ed_detail_wrap light">
            <ul class="cources_facts_list">
              ...
              <li class="facts-1"><a href="{{ route('services') }}">Services</a></li>
            </ul>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 mb-4">
            <div class="education_block_grid style_2 mb-4">
              ...
              <div class="education_block_body">
                <h4 class="bl-title"><a
                    href="{{ route('service.detail', ['service_slug' => $row->slug]) }}">{{ $row->title }}</a></h4>
                <p class="mb-2">{{ $row->shortnote }}</p>
              </div>
              <div class="education_block_footer align-items-center p-3">
                <div class="education_block_author"><a
                    href="{{ route('service.detail', ['service_slug' => $row->slug]) }}" class="card-btn">Read More</a>
                </div>
              </div>
            </div>
          </div>
